                ...
                builder: (a) {
                  return FadeSlideTransition(
                    ...
                    child: CustomTextfieldCommon(
                      controller: a.ForgetemailController,
                      label: 'Email',
                      hint: 'Email',
                      textInputType: TextInputType.emailAddress,
                      validate: a.ForgetPasswordvalidate,
                      errorText: a.forgetPasswordEmailError,
                      btnValidate: a.isForgetPasswordValidate,
                    ),
                  );
                },
              ),
    ...
    return GetBuilder<UserLoginController>(
      ...
      builder: (a) {
        return MaterialButton(
            ...
            onPressed: () {
              a.isForgetPasswordValidate = true;
              a.update();
              a.ForgetPasswordvalidate();
              if (a.forgetPasswordEmailError == null) {
                loaderShow(context);
                a.forgetPasswordEmail = a.ForgetemailController.text;
                a.forgetPasswordApi();
              }
              // Navigator.push(
              //     context,
