...
import 'package:gleekeyu/src/Menu/Bookings/bookings_view.dart';
import 'package:gleekeyu/src/Menu/DashBoard/dashboard_controller.dart';
import 'package:gleekeyu/src/Menu/DashBoard/dashboard_view.dart';
import 'package:gleekeyu/src/Menu/WishList/AddWishList_Widget/addWishlist_controller.dart';
import 'package:gleekeyu/src/Menu/WishList/wishlistedProperties_controller.dart';
import 'package:gleekeyu/src/Menu/WishList/wishlistedProperties_view.dart';
import 'package:gleekeyu/src/SubPages/notification.dart';
...
class HomePageController extends GetxController {
  ...
  void goto(
    ...
    print("ISUserLogedIN : ${a.isUserLogedIn}");
    if (i > 0 && !a.isUserLogedIn) {
      pageChange();
      currentIndex = 0;
      i = 0;
      update();
