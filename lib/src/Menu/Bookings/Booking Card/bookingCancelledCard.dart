        ...
        children: [
          Bounce(
            ...
            onPressed: () {
              Get.to(
                () => PropertyAllDetails(
                  slug: canceledBookings['properties']['slug'],
                  startDate:"",
                  endDate: "",
                  fromSearch: false,
                  isPropertyActive: canceledBookings['properties']
                              ['property_status'] ==
                          "Inactive"
                      ? false
                      : true,
                  id: canceledBookings['properties']['id'].toString(),
                ),
              );
            },
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(canceledBookings['properties']
                              ['cover_photo'] ??
                          ''))),
              child: Stack(
                children: [
          ...
          Padding(
            ...
            child: SizedBox(
              child: Row(
                children: [
                  Text(
                    canceledBookings['properties']['property_name'],
                  ...
                  Text(canceledBookings['properties']['avg_rating'].toString(),
                  ...
                  Text(
                      "(${canceledBookings['properties']['reviews_count'].toString()})",
                      style: Palette.bestText1),
                ],
              ),
            ),
            ...
            child: SizedBox(
              child: Row(
                children: [
                  ...
                  Text(
                    (canceledBookings['code']).toString(),
                  ...
                  Text(
                    DateFormat('yyyy-MM-dd')
                        .format(DateTime.parse(canceledBookings['created_at'])),
                    style: Palette.bestText3,
                  ),
                ],
              ),
                  ...
                  RichText(
                    text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                "${DateFormat.d().format(DateTime.parse(canceledBookings['start_date']))} ${DateFormat.MMM().format(DateTime.parse(canceledBookings['start_date']))} ${DateFormat.y().format(DateTime.parse(canceledBookings['start_date']))}",
                            style: Palette.bestText3,
                          )
                        ]),
                  ),
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text:
                              "${DateFormat.d().format(DateTime.parse(canceledBookings['end_date']))} ${DateFormat.MMM().format(DateTime.parse(canceledBookings['end_date']))} ${DateFormat.y().format(DateTime.parse(canceledBookings['end_date']))}",
                          style: Palette.bestText3,
                        )
                      ],
                    ),
