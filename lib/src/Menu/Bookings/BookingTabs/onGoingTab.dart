...
import 'package:gleekeyu/src/Menu/Bookings/Booking%20Card/bookingOnGoingCard.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                            ...
                            itemCount: a.onGoingBookings.length,
                            itemBuilder: ((context, index) {
                              return Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  BookingOnGoingCard(
                                    onGoingBookings: a.onGoingBookings[index],
                                  ),
                                  index != a.onGoingBookings.length - 1
                                      ? const Divider(
                                          color: kDarkGrey,
                                          height: 1,
                                        )
