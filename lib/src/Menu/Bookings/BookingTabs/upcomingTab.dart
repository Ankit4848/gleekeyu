...
import 'package:gleekeyu/src/Menu/Bookings/Booking%20Card/bookingUpcomingCard.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                            ...
                            itemCount: a.upcomingBookings.length,
                            itemBuilder: ((context, index) {
                              return Column(
                                ...
                                children: [
                                  BookingUpcomingCard(
                                    upcomingProperties:
                                        a.upcomingBookings[index],
                                  ),
                                  index != a.upcomingBookings.length - 1
                                      ? const Divider(
                                          color: kDarkGrey,
                                          height: 1,
                                        )
