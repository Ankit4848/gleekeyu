...
class Data {
  ...
  List<Properties>? bestSellerProperty;
  List<Properties>? populerProperties;
  ...
  Data({
    ...
    this.bestSellerProperty,
    this.gleekeyChoiceProperty,
    this.populerProperties,
  });
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['gleekey_choice'] != null) {
      gleekeyChoiceProperty = <Properties>[];
      json['gleekey_choice'].forEach((v) {
        gleekeyChoiceProperty!.add(Properties.fromJson(v));
      });
    }
    ...
    if (json['best_seller_properties'] != null) {
      bestSellerProperty = <Properties>[];
      json['best_seller_properties'].forEach((v) {
        bestSellerProperty!.add(Properties.fromJson(v));
      });
    }
    if (json['best_popular_properties'] != null) {
      populerProperties = <Properties>[];
      json['best_popular_properties'].forEach((v) {
        populerProperties!.add(Properties.fromJson(v));
      });
    }
...
class Properties {
  ...
  List<PropertyDates>? propertyDates;
  ...
  Properties.fromJson(Map<String, dynamic> json) {
    ...
    // minDay = json['min_day'];
    if (json['min_stay'] != null) {
      if (json['min_stay'] is int) {
        minStay = json['min_stay'];
      } else {
        minStay = int.tryParse(json['min_stay'].toString());
      }
    }
    if (json['min_day'] != null) {
      if (json['min_day'] is int) {
        minDay = json['min_day'];
      } else {
        minDay = int.tryParse(json['min_day'].toString());
      }
    }
    ...
    propertyPrice =
        json['property_price'] != null
            ? PropertyPrice.fromJson(json['property_price'])
            : null;
    propertyAddress =
        json['property_address'] != null
            ? PropertyAddress.fromJson(json['property_address'])
            : null;
    if (json['property_dates'] != null) {
      propertyDates = <PropertyDates>[];
      json['property_dates'].forEach((v) {
        propertyDates!.add(PropertyDates.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['offer_status'] = offerStart;
    data['offer_start'] = offerStart;
    ...
    if (propertyDates != null) {
      data['property_dates'] = propertyDates!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class PropertyDates {
  int? id;
  int? propertyId;
  String? propertyHotelAttributeId;
  String? status;
  int? price;
  int? minStay;
  int? minDay;
  ...
  PropertyDates.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    propertyId = json['property_id'];
    propertyHotelAttributeId = json['property_hotel_attribute_id'];
    status = json['status'];
    price = json['price'];
    minStay = json['min_stay'];
    minDay = json['min_day'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['property_hotel_attribute_id'] = this.propertyHotelAttributeId;
    data['status'] = this.status;
    data['price'] = this.price;
    data['min_stay'] = this.minStay;
