...
//                         children: [
//                           Text(
//                             '₹ ${a.PropertyData!.result!.propertyPrice!.price * (_C.totalNight ?? 1)} /${_C.totalNight ?? ""} Night',
...
//                                 text:
//                                     ' GST ₹${((a.PropertyData!.result!.propertyPrice!.price * (_C.totalNight ?? 1)) * 18) / 100} Excluded',
//                                 fontSize: 10,
//                               ),
//                             ],
//                           ),
