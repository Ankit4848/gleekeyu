                          ...
                          children: [
                            ...
                            GetBuilder<SearchPlacesController>(
                                ...
                                builder: (a) {
                                  ...
                                  print("a.startDate.value");
                                  print(a.startDate.value);

                                  return viewCalanderInFilter(
                                    date:a.startDate.value!=""? a.startDate.value : "Start Date",
                                  );
                                }),
                            const SizedBox(
                              height: 12,
                            ...
                            GetBuilder<SearchPlacesController>(
                                ...
                                builder: (a) {
                                  return viewCalanderInFilter(
                                    date: a.endDate.value!=""?a.endDate.value : "End Date",
                                  );
                                }),
                            const SizedBox(
                              height: 12,
                                        ...
                                        children: [
                                          GetBuilder<SearchPlacesController>(
                                              ...
                                              builder: (a) {
                                                return commonText(
                                                  text:
                                                      "${a.totalAdults} Adults, ${a.totalChildren} Children, ${a.totalInphant} Infants",
                                                  color: kBlack,
                                                  fontSize: 11,
                                                  fontWeight: FontWeight.w700,
                                                );
                            ...
                            Row(
                              ...
                              children: [
                                Bounce(
                                  ...
                                  onPressed: () {
                                    SearchPlacesController a =
                                        Get.put(SearchPlacesController());
                                    a.pridiction = [];
                                    a.selectedPlace = "Search Places";
                                    a.startDate.value = "";
                                    a.endDate.value = "";
                                    a.totalAdults.text = '1';
                                    a.totalChildren.text = '0';
                                    a.totalInphant.text = "0";
                                    a.update();
                                  },
                                  child: Container(
                                    height: 30,
